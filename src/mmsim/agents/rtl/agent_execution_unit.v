...
module agent_execution_unit #(
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            // Default: deassert order_valid every cycle
            order_valid <= 1'b0;
            ...
            case (state)
                ...
                kStateEmit: begin
                        ...
                        case (calc_agent_type)
                            ...
                            2'b10: begin // MOMENTUM TRADER
                                ...
                                order_packet <= {
                                    ...
                                    3'b000,
                                    final_price,
                                    // Volume calculation: min((dsp_product >> 10) + 1, param3)
                    ...
                    // Advance slot counter, wrap at active_agent_count

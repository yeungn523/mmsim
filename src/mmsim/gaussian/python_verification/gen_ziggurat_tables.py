...
Builds the 256-layer Marsaglia and Tsang ziggurat decomposition for N(0, 1) and emits the
Q4.12 tables as a Quartus MIF, a Verilog include, and a Python module so the float, MIF,
Verilog, and golden-model representations agree bit-for-bit.
"""
